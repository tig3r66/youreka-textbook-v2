...
This text focuses on how the material taught in-session can be applied using the R programming language. As with all programming languages, the best way to learn is to actively code. That is, when you read this textbook, open up R Studio and copy the code verbatim. Then, play around with the code---try to find alternative solutions, or even break the code. Don't be afraid to make mistakes, and soon enough, you will be confident to code on your own!
