...
1. **ggsignif**: This package extends the ggplot2 package. It adds additional statistical visualization func- tions. Read more [here](https://cran.r-project.org/web/packages/ggsignif/vignettes/intro.html).
