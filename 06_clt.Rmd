...
1. With a larger sample size, your estimation for the mean will have a smaller error.
...
This example may appear intuitive: when you flip the coin many times, you will likely get "heads" 50% of the time. How about an "uneven" coin that preferably lands with a "head" with 75% chance? In this case we change the `prob` in the `sample()` function with this new probability.
